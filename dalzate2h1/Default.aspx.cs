...
namespace dalzate2h1
{
    public partial class _Default : Page
    {
        ...
        protected void DateCalcuationButton_Click(object sender, EventArgs e)
        {
            ...
            TextBox3aResult0.Text = DateTime.Today.Year.ToString();
            TextBox3bResult0.Text = DateTime.Today.Month.ToString();
            TextBox3bResult1.Text = DateTime.Today.Day.ToString();
        ...
        protected void StringCalcuationButton_Click(object sender, EventArgs e)
        {
